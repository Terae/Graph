...
TEST_CASE("constructors") {
    ...
    SECTION("inialize an empty graph") {
        ...
        SECTION("graph<bool, bool, bool>") {
            graph<bool, bool, bool> g(DIRECTED);
            g[true] = true;
            g[false] = false;
            g(true, false) = true;
        ...
        SECTION("Cycled graph") {
            SECTION("directed") {
                graph<std::string, int, double> g(DIRECTED);
                g("node 1", "node 2") = 1.2;
                g("node 2", "node 3") = 2.3;
                g("node 3", "node 1") = 3.1;
